...
export function inspectValue(value: unknown, seen = new Map<object, InspectionValue>()): InspectionValue {
    if (typeof value === "symbol") return value.description;
    if (typeof value === "function") return "[Function]";
    if (value === null || value === undefined || typeof value === "string" ||
        typeof value === "number" || typeof value === "boolean" || typeof value === "bigint") return value;
    ...
    for (const [key, child] of Object.entries(value))
        Object.defineProperty(copy, key, {
            value: inspectValue(child, seen), enumerable: true,
        });
    return Object.freeze(copy);
}
