...
import { BrowserSession, browserExecutable } from "../../../core/browser/session.js";
...
const SUMMARY = `(async (startMs, endMs) => {
    ...
    return {
        ...
        raw: { callbackMs, intervalMs, heap },
...
try {
    ...
    if (IS_RENDERER || SAMPLES_ALLOCATIONS) {
        ...
        if (IS_RENDERER) {
            ...
            return { raw: { prepare: [...prepare], submit: [...submit], total: [...total] }, metadata:b.metadata, metrics:b.metrics, error:b.error,
